        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <section>                
                    ...
                    <div class="my-4">
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" wire:click="create">Adicionar mesa</button>
                    </div>
                    @if($isOpen)
                    <div class="fixed inset-0 flex items-center justify-center z-50">
                       ...
                       <h2 class="text-2xl font-bold mb-4">{{ $tableId ? 'Editar mesa' : 'Cria mesa' }}</h2>                            	
                            <form wire:submit.prevent="{{ $tableId ? 'update' : 'store' }}">
                                <div class="mb-4">
                                    <label for="number" class="block text-gray-700 font-bold mb-2">Número:</label>
                                    <input type="text" wire:model="number" id="number" class="w-full border border-gray-300 px-4 py-2 rounded">	
                                ...
                                <div class="flex justify-end">
                                    ...
                                    <button type="submit" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mr-2">{{ $tableId ? 'Atualizar' : 'Criar' }}</button>
                        ...
                        <tbody wire:key="{{ $table->id }}>
                            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4 flex items-center justify-center space-x-0">
                                    <button class="" wire:click="edit({{ $table->id }})">
                                    ...
                                    <button class="" wire:click="delete({{ $table->id }})">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="ml-2 mt-0 w-4 h-4">
