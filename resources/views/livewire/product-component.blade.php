        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                ...
                <section>                
                    ...
                    <div class="my-4">
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" wire:click="create">Adicionar produto</button>
                    </div>
                    @if($isOpen)
                    <div class="fixed inset-0 flex items-center justify-center z-50">
                       ...
                       <h2 class="text-2xl font-bold mb-4">{{ $productId ? 'Editar produto' : 'Cria produto' }}</h2>                            	
                            <form wire:submit.prevent="{{ $productId ? 'update' : 'store' }}">
                                <div class="mb-4">
                                    <label for="name" class="block text-gray-700 font-bold mb-2">Nome:</label>
                                    <input type="text" wire:model="name" id="name" class="w-full border border-gray-300 px-4 py-2 rounded">	
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" wire:model="price" id="price" class="w-full border border-gray-300 px-4 py-2 rounded">
                                    <span class="text-red-500">@error('price') {{ $message }} @enderror</span>

                                </div>
                                <div class="flex justify-end">
 
                                    <button type="submit" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded mr-2">{{ $productId ? 'Atualizar' : 'Criar' }}</button>
